...
function onEvent(name, value1, value2)
    ...
    elseif name == "Set_Cam_Zoom" or name == "setcamzoomb" then
        ...
        if value2 == nil or value2 < 0.012 then
            ...
            doTweenZoom(isSetCamZoom and 'camzs' or 'camzb', 'camGame', value1, duration, 'cubeOut')
            gameZooming = true
        end
    elseif name == "Set_Cam_Zoom_cI" then
        local isSetCamZoom = name == "Set_Cam_Zoom_cI"
        ...
        if value2 == nil or value2 < 0.012 then
            ...
            setProperty('camZoomsBg', false)
            local duration = isSetCamZoom and value2 or ((value2 + 1) * (60 / getPropertyFromClass('backend.Conductor', 'bpm')) * 250) / 1000
            doTweenZoom(isSetCamZoom and 'camzs' or 'camzb', 'camGame', value1, duration, 'cubeIn')
            gameZooming = true
        end
    end
end
