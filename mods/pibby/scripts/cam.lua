...
function tilt()
    ...
    if anim == 'singLEFT' or anim == 'singLEFTmiss' then
        doTweenAngle('camFollow.a', 'camGame', 1.5, 0.2,'smoothInOut');
    end
    if anim == 'singRIGHT' or anim == 'singRIGHTmiss' then
        doTweenAngle('camFollow.a', 'camGame', -1.5, 0.2,'smoothInOut');
    end
    if anim == 'singDOWN' or anim == 'singDOWNmiss' then
        doTweenAngle('camFollow.a', 'camGame', 0, 0.2,'smoothInOut');
    end
    if anim == 'singUP' or anim == 'singUPmiss' then
        doTweenAngle('camFollow.a', 'camGame', 0, 0.2,'smoothInOut');
    end
    if anim == 'idle' then
        doTweenAngle('camFollow.a', 'camGame', 0, 0.2,'smoothInOut');
...
function onUpdate(dt)
	if gfSection or mustHitSection then
		if songName == 'Blessed by Swords' then
		   setProperty("defaultCamZoom",1.1)
		end
	elseif curBeat >= 4 then
		setProperty("defaultCamZoom",def)
	 end
	time = time + dt
